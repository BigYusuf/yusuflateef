export const list = [
  ...
  export const allData = [
    ...
    { id: 5, img: "/image/pic-3.png", title: "Web design",
    frontend:"React, Native CSS",
    desc: "Service with more than 3 years of experience. Providing quality work to clients and companies",
    images:[{img1:"/image/pic-3.png"}, {img1:"/image/pic-4.png"}, {img1:"/image/pic-5.png"}, {img1:"/image/pic-6.png",}],
},

{ id: 7, img: "/image/car-7.png", title: "Brand design",
frontend:"React, Native CSS1",
desc: "Service with more than 3 years of experience. Providing quality work to clients and companies",
images:[{img1:"/image/car-7.png"}, {img1:"/image/car-8.png"}, {img1:"/image/car-3.png"}, {img1:"/image/car-4.png",}],
},
{ id: 8, img: "/image/vehicle-5.png", title: "API",
frontend:"No frontend",
desc: "Service with more than 3 years of experience. Providing quality work to clients and companies",
images:[{img1:"/image/vehicle-5.png"}, {img1:"/image/vehicle-6.png"}, {img1:"/image/vehicle-1.png"}, {img1:"/image/vehicle-2.png",}],
},
{ id: 9, img: "/image/pic-6.png", title: "Web design",
frontend:"React, Native CSS",
desc: "Service with more than 3 years of experience. Providing quality work to clients and companies",
images:[{img1:"/image/pic-6.png"}, {img1:"/image/pic-6.png"}, {img1:"/image/pic-1.png"}, {img1:"/image/pic-2.png",}],
},
];

export const webData = [
    { id: 10, img: "/image/w1.jpeg", title: "Web design 1",
    frontend:"React, Native CSS",
    backend:"Node,Express, firebase1",
    desc: "Service with more than 3 years of experience. Providing quality work to clients and companies",
    images:[{img1:"/image/w1.jpeg"}, {img1:"/image/w2.jpeg"}, {img1:"/image/w3.png"}, {img1:"/image/w4.png",}],
},
